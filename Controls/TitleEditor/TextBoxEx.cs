...
namespace ExpertLib.Controls
{
    ...
    public partial class TextBoxEx : TextBox
    {
        ...
        public Color PromptColor { get; set; } = Color.Gray;
        ...
        public TextBoxEx()
        {
            ...
            base.GotFocus += TextBoxEx_GotFocus;
            base.MouseUp += TextBoxEx_MouseUp;
        ...
        private void TextBoxEx_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                if (!ControlHelper.CheckInputType(this.Text, this._inputType, this._maxValue, this._minValue, this.DecLength, this._regexPattern))
                {
                    ...
                    base.TextChanged -= TextBoxEx_TextChanged;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (var graphics = Graphics.FromHwnd(base.Handle))
            {
                if (this.Text.Length != 0 || string.IsNullOrEmpty(this.PromptText)) return;
                ...
                TextRenderer.DrawText(graphics, this.PromptText, this.PromptFont, base.ClientRectangle, this.PromptColor, textFormatFlags);
            }
        }
